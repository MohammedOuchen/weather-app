<template>
  <div class="p-6 bg-white shadow-lg rounded-lg max-w-lg mx-auto">
    <label for="city" class="block text-gray-700 font-semibold text-lg">Select a city:</label>
    ...
    <div v-if="forecastData" class="mt-6">
      <h3 class="text-xl font-bold text-gray-800 text-center">7-day Forecast:</h3>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
        <div v-for="day in forecastData.forecast.forecastday" :key="day.date" class="bg-blue-100 p-4 rounded-lg shadow-md text-center">
          ...
          <p class="text-gray-600">Temp: <span class="font-bold">{{ day.day.avgtemp_c }}°C</span></p>
